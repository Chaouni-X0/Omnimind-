  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `api_keys` (`id` TEXT NOT NULL, `providerName` TEXT NOT NULL, `encryptedKey` TEXT NOT NULL, `baseUrl` TEXT, `modelId` TEXT NOT NULL, `modelTier` INTEGER NOT NULL, `priorityWeight` INTEGER NOT NULL, `monthlyBudgetCents` INTEGER, `currentSpentCents` INTEGER NOT NULL, `isEnabled` INTEGER NOT NULL, `lastUsedTimestamp` INTEGER NOT NULL, `lastError` TEXT, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e0530a51923ea72aca54e0a8bd0521c5')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsApiKeys = new HashMap<String, TableInfo.Column>(12);
        ...
        _columnsApiKeys.put("modelId", new TableInfo.Column("modelId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsApiKeys.put("modelTier", new TableInfo.Column("modelTier", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "e0530a51923ea72aca54e0a8bd0521c5", "bb83bda427498d629ca55e7184fc1102");
