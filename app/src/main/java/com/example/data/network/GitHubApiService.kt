...
interface GitHubApiService {
    ...
    @GET
    suspend fun downloadRaw(@Url url: String, @Header("Authorization") auth: String): okhttp3.ResponseBody
}

data class GitHubUser(val login: String, val name: String?, val avatar_url: String?, val public_repos: Int = 0)
